...
extern uint8_t mpu6050id(void);
extern uint8_t MPU6050GetAngle(float *angleX,float *angleY,float *angleYX);
extern uint8_t MPU6050DataGet(float *accel, float *temperature);
extern void MPU6050ReadAcc(float *accData);
